...
class VariantsControllerTest < ActionController::TestCase
  ...
  test "should create variant" do
    assert_difference('Variant.count') do
      post :create, variant: { price: @variant.price, production_id: @variant.production_id, size: @variant.size }
    end
  ...
  test "should update variant" do
    patch :update, id: @variant, variant: { price: @variant.price, production_id: @variant.production_id, size: @variant.size }
    assert_redirected_to variant_path(assigns(:variant))
  end
